...
public class CustomerControllerTest {
    ...
    private CustomerRequestDto createNewCustomer(){
        return CustomerRequestDto.builder().name("Josefa").email("josefa@email.com")
                .document("39516475078").documentType(documentType.PF).phoneNumber("11999999999")
                .build();
    }
    @Test
    ...
    public void createCustomerTest() throws Exception{
        ...
        Customer savedCustomer = Customer.builder()
                ...
                .document("39516475078")
                .documentType(documentType.PF)
                .phoneNumber("11999999999")
                .addresses(null)
                .build();

        BDDMockito.given(service.save(Mockito.any(CustomerRequestDto.class))).willReturn(savedCustomer);
    ...
    public void createCustomerWithDuplicatedDocument() throws Exception{ //validação Regra de Negócio
        ...
        BDDMockito.given(service.save(Mockito.any(CustomerRequestDto.class)))
